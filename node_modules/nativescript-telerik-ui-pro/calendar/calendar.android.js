...
})(exports.CellStyleType || (exports.CellStyleType = {}));
var CellStyleType = exports.CellStyleType;
...
var CalendarYearViewStyle = (function (_super) {
    ...
    CalendarYearViewStyle.prototype.onMonthCellStyleChanged = function (data) {
        if (this._owner && this._owner.android) {
            ...
            if (data.newValue) {
                data.newValue.nativeOwner = this._owner.android;
            ...
            if (nativeMode == com.telerik.widget.calendar.CalendarDisplayMode.Year) {
                if (this._android.isYearModeCompact() != bSetYearMode) {
                    if (this._android.getDisplayMode() == com.telerik.widget.calendar.CalendarDisplayMode.Year) {
                        // The NS calendar view modes Year and MonthName are both represened by CalendarDisplayMode.Year in android.
...
//# sourceMappingURL=calendar.android.js.map