...
var RadPieChart = (function (_super) {
    ...
    RadPieChart.prototype.onSelectionModeChanged = function (data) {
        ...
        if (data.newValue) {
            if (publicEnumModule.ChartSelectionMode.Single.toLowerCase() === data.newValue.toLowerCase()) {
                this.ios.selectionMode = 1 /* Single */;
            }
            else if (publicEnumModule.ChartSelectionMode.Multiple.toLowerCase() === data.newValue.toLowerCase()) {
    ...
    RadPieChart.prototype.onPalettesChanged = function (data) {
        _super.prototype.onPalettesChanged.call(this, data);
        if (data.newValue instanceof observable_array_1.ObservableArray) {
    ...
    RadPieChart.prototype.onSeriesSelectionModeChanged = function (data) {
        if (!this.ios) {
            return;
        }
        if (data.newValue) {
            if (publicEnumModule.ChartSelectionMode.Single === data.newValue) {
                this.ios.seriesSelectionMode = 1 /* Single */;
            }
            else if (publicEnumModule.ChartSelectionMode.Multiple === data.newValue) {
                this.ios.seriesSelectionMode = 2 /* Multiple */;
            }
            else if (publicEnumModule.ChartSelectionMode.None === data.newValue) {
                this.ios.seriesSelectionMode = 0 /* None */;
            }
        }
    };
    RadPieChart.prototype.onPointSelectionModeChanged = function (data) {
        if (!this.ios) {
            return;
        }
        if (data.newValue) {
...
var RadCartesianChart = (function (_super) {
    ...
    RadCartesianChart.prototype.onSeriesChanged = function (data) {
        ...
        if (data.oldValue) {
            for (var i = 0; i < data.oldValue.length; ++i) {
                data.oldValue.getItem(i).owner = undefined;
            }
        }
        if (this.series) {
            for (var i = 0; i < this.series.length; ++i) {
    ...
    RadCartesianChart.prototype.onGridChanged = function (data) {
        if (data.newValue instanceof cartesianChartGridModule.RadCartesianChartGrid) {
    ...
    RadCartesianChart.prototype.onSelectionModeChanged = function (data) {
        ...
        if (data.newValue) {
            var newVal = data.newValue.toLowerCase();
...
//# sourceMappingURL=chart.ios.js.map