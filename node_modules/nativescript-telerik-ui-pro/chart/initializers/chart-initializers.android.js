        ...
        if (data.eventName && data.eventName.toLowerCase() === "change") {
            ...
            if (collectionData.action && collectionData.action.toLowerCase() === "splice") {
                if (collectionData.removed instanceof observable_array_1.ObservableArray) {
                    for (var serieIndex_1 = 0; serieIndex_1 < collectionData.removed.length; serieIndex_1++) {
                        if (chart.androidView.getSeries().indexOf(collectionData.removed.getItem(serieIndex_1).android) !== -1) {
                            chart.androidView.getSeries().remove(collectionData.removed.getItem(serieIndex_1).android);
                        }
                    }
                }
                else {
                    for (var serieIndex_2 = 0; serieIndex_2 < collectionData.removed.length; serieIndex_2++) {
                        if (chart.androidView.getSeries().indexOf(collectionData.removed[serieIndex_2].android) !== -1) {
                            chart.androidView.getSeries().remove(collectionData.removed[serieIndex_2].android);
                        }
                    }
                }
                return;
            ...
            if (propertyData.oldValue) {
                if (chart.androidView) {
                    if (propertyData.oldValue instanceof observable_array_1.ObservableArray) {
                        for (var serieIndex = 0; serieIndex < propertyData.oldValue.length; serieIndex++) {
                            if (chart.androidView.getSeries().indexOf(propertyData.oldValue.getItem(serieIndex).android) !== -1) {
                                chart.androidView.getSeries().remove(propertyData.oldValue.getItem(serieIndex).android);
                            }
                        }
                    }
                    else {
                        for (var serieIndex_3 = 0; serieIndex_3 < propertyData.oldValue.length; serieIndex_3++) {
                            if (chart.androidView.getSeries().indexOf(propertyData.oldValue[serieIndex_3].android) !== -1) {
                                chart.androidView.getSeries().remove(propertyData.oldValue[serieIndex_3].android);
                            }
                        }
                    }
                }
