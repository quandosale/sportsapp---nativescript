...
var EntityProperty = (function (_super) {
    ...
    EntityProperty.prototype.onEditorChanged = function (data) {
        ...
        if (data.newValue instanceof commonModule.PropertyEditor) {
            var that = new WeakRef(this);
...
var CustomPropertyEditor = (function (_super) {
    ...
    CustomPropertyEditor.prototype.onStyleChanged = function (data) {
        PropertyEditorHelper.applyStyle(this);
    };
...
var PropertyEditorHelper = (function () {
    ...
    PropertyEditorHelper._onNativeSet = function (editor) {
        ...
        editor.android.getEditorView().setEnabled(editorEnabled);
    ...
    PropertyEditorHelper.applyStyle = function (editor) {
        ...
        PropertyEditorHelper._updateLabelFont(editor, editor.style.labelFontName, editor.style.labelFontStyle);
        PropertyEditorHelper._updateLabelTextSize(editor, editor.style.labelTextSize);
        PropertyEditorHelper._updateLabelHorizontalOffset(editor, editor.style.labelHorizontalOffset);
        PropertyEditorHelper._updateLabelVerticalOffset(editor, editor.style.labelVerticalOffset);
        PropertyEditorHelper._updateEditorHorizontalOffset(editor, editor.style.editorHorizontalOffset);
        PropertyEditorHelper._updateEditorVerticalOffset(editor, editor.style.editorVerticalOffset);
        PropertyEditorHelper._updateEditorFillColor(editor, editor.style.fillColor);
        PropertyEditorHelper._updateEditorStroke(editor, editor.style.strokeColor, editor.style.strokeWidth, editor.style.fillColor);
...
//# sourceMappingURL=dataform.android.js.map