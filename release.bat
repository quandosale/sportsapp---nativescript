...
tns build android --release --key-store-path sports.keystore --key-store-password 123456 --key-store-alias google --key-store-alias-password 123456 --copy-to sportsapp.apk
REM tns build android --debug --key-store-path sports.keystore --key-store-password 123456 --key-store-alias google --key-store-alias-password 123456
